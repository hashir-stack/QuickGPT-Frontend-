...
const Chatbox = () => {
  ...
  return (
    ...
    >
        ...
        {messages.length === 0 && (
          <div className="h-full flex flex-col items-center justify-center gap-2 text-primary">
            <img
              ...
              alt="Logo"
              className="w-full max-w-40 sm:max-w-56 md:max-w-68"
            />
            <p
              className="
                mt-5 text-2xl sm:text-4xl md:text-6xl 
      ...
      {/* Publish the image in community */}
      {mode === "image" && (
      ...
      <form
        ...
        className="
          ...
          mx-auto flex gap-2 sm:gap-4 items-center
        "
      >
        <select
          onChange={(e) => setMode(e.target.value)}
          value={mode}
          className="text-sm pl-2 sm:pl-3 pr-2 outline-none"
        >
